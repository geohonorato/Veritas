      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        navItems.forEach((item, idx) => {
          item.addEventListener('click', (e) => {
            ...
            if (item.textContent.includes('Configurações') || item.textContent.includes('Configurações')) {
      ...
      if (saveSettingsBtn) {
        saveSettingsBtn.addEventListener('click', async () => {
          ...
          try {
            ...
            if (saved) {
              showCustomAlert('Sucesso', 'Configurações salvas!');
            }
          } catch (err) {
      ...
      if (toggleAiChatBtn && aiChatWindow) {
        toggleAiChatBtn.addEventListener('click', () => {
          ...
          if (!aiChatWindow.classList.contains('hidden')) {
            ...
            // Renderiza sugestões se o chat estiver vazio
